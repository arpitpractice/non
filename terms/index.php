...
<center style="background-color:#302E2E;padding:15px;color:#fff !important;position:relative;top:-16px;">
    <h2>Terms</h2>
</center>
<style>
    p,hr,center,h3,ul,li{
        color:#855c31 !important;
    }
</style>
<br/><br/>
<div class="container">
    <div class="row">
        <div class="col-sm-12 col-lg-12 col-md-12">
            ...
            <ul>
                ...
                <br/><br/>
                <li>
                    You and any third-party further agree that no proceeding against jamaliate, its affiliates, or any service service providers or companies offering products or services through the site (under this provision or otherwise) may proceed as a class action, be joined with another person’s claim, or proceed on a basis involving claims brought in a purported representative capacity (either on behalf of the general public or other users or persons). Any and all proceedings to resolve claims will be conducted only on an individual basis. In addition, no arbitration proceeding under this provision shall be consolidated or joined in any way with any other arbitration proceeding without the express written consent of all parties.
                </li>
                <br/><br/>
                <li>
                    For any arbitration initiated pursuant to this agreement involving Claims that together seek damages that do not exceed $25 jamaliate will reimburse you for all fees and costs imposed by AAA. If you are unable to pay the filing fee, jamaliate will p'ay it for you. For any arbitration involving Claims that together seek damages that exceed $25, if you, or any Third-party, prevail in the arbitration of any Claim against jamaliate, jamaliate will reimburse such prevailing party for any fees or costs the prevailing party paid to AAA in connection with the arbitration.
                </li>
                <br/><br/>
                <li>
                    If you prevail in the arbitration of any Claim against jamaliate and are awarded an amount greater than jamaliate’s last written settlement offer to you, jamaliate will pay a minimum recovery of $5 and jamaliate will reimburse you for all reasonable attorney’s fees incurred in arbitrating the Claim(s) upon which you have prevailed. If any Third-party prevails in the arbitration of any Claim against jamaliate and is awarded an amount greater than jamaliate’s last written settlement offer to such Third-party, jamaliate will pay a minimum recovery of $5 to the Third-party, and jamaliate will reimburse such Third-party for all reasonable attorney’s fees incurred in arbitrating the Claim upon which he or she has prevailed. Any dispute regarding attorney’s fees to be paid pursuant to this paragraph will be decided by the arbitrator who decided the underlying Claim. If you or the Third-party do not prevail on the claim or prevail but are awarded an amount less than or equal to jamaliate’s last written settlement offer to you, jamaliate will pay only the amount of the award, not the minimum recovery or attorneys’ fees.
                </li>
                <br/><br/>
                <li>

                    Notwithstanding any other provision of law or any of the Rules and Procedures established by AAA which may be to the contrary, jamaliate will not be entitled to seek reimbursement of its attorney’s fees for any Claim the arbitrator finds to be non-frivolous.
                </li>
                <br/><br/>
                <li>
                    With the exception of sub-part (e) above (the class action waiver), if any part of this arbitration provision is held to be invalid, unenforceable or illegal, or otherwise conflicts with the Rules and Procedures established by AAA, then the balance of this arbitration provision shall remain in effect and shall be construed in accordance with its terms as if the invalid, unenforceable, illegal or conflicting provision were not contained herein. If, however, subpart (e) above (the class action waiver) is held to be invalid, unenforceable or illegal, then the entirety of this arbitration provision shall be null and void, and neither you nor any Third-party, nor jamaliate shall be entitled to arbitrate their dispute.
                </li>
                <br/><br/>
                <li>
                ...
                <br/><br/>
                <li>
                    <span style="font-weight:700;">If you or any third-party do not choose to accept this binding arbitration provision, you or such third-party must notify jamaliate in writing by certified mail within thirty (30) days of your purchase or before you begin to use the services purchased on this site, whichever date is sooner.</span> Such notice shall be sent to the notice address defined in subsection (b), above. If you so notify us by that time that you do not accept the binding arbitration provision, you and any such third-party may not continue to purchase services or products on this site unless and until jamaliate notifies you or such third-party otherwise. jamaliate shall have the right to prohibit your and such third-party’s future purchase of services or products on this site.
                </li>
            </ul>
            <br/><br/>
            <p class="text-justify">      By using our service, you accept and agree to the relevant cancellation policy of that provider. In all cases, the cancellation policy of each reservation is made available on our website. Please note that certain rates or special offers are not eligible for cancellation or change. jamaliate deems the following chargeback scenarios as improper and retains the right to investigate and rebut any such chargeback claims and to recover costs of such chargeback claims from You, the User.</p>
            <ul class="text-justify">
                ...
                <li>
                    Chargebacks resulting from force majeure or other circumstances that are beyond the control of jamaliate.com or its subsidiaries.
            ...
            <ul class="text-align:justify">
                <li>
                    All content contained within or available through this site are provided to you on an "as is," basis. Inkarn.com makes no representations or warranties of any kind, either express or implied, as to the operation of this website or the information, content or materials included on this website. To the fullest extent permissible, Inkarn.com disclaims all representations and warranties, including, but not limited to, the implied warranties of merchantability or satisfactory workmanlike effort, informational content, title, or non-infringement of the rights of third parties. Inkarn.com does not warrant or make any representations that this site will operate error-free or uninterrupted, that defects will be corrected, or that this site and/or its servers will be free of viruses and/or other harmful components.<span class="font-weight:700;"> Inkarn.com does not warrant or make any representations regarding suitability, availability, accuracy, reliability, completeness, or timeliness of any material of any kind contained within this site for any purpose, including software, products, services, information, text and related graphics content. </span>
                </li>
                <li>

                    Without limiting the foregoing, no warranty or guarantee is made (i) regarding the acceptance of any request, <br>(ii) that a user will receive the lowest available price for goods and/or services available through this site,<br> (iii) regarding the availability of products and/or services through this site or, where applicable, at any participating retailer or retailer location, or<br> (iv) regarding the results that may be obtained from the use of this site.

                </li>
            </ul>
            <h3 class="text-align:justify;"> General Limitation of Liability</h3>
            <ul>
                <li>
                    <span style="font-weight:700;"> To the extent permitted by law, in no event shall jamaliate.com, including its respective officers, directors, employees, representatives, parents, subsidiaries, affiliates, distributors, suppliers, licensors, agents or others involved in creating, sponsoring, promoting, or otherwise making available the site and its contents (collectively the "Covered Parties"), be liable to any person or entity whatsoever for any direct, indirect, incidental, special, exemplary, compensatory, consequential, or punitive damages or any damages whatsoever,including but not limited to:</span> (i) loss of goodwill, profits, business interruption, data or other intangible losses;<br/> (ii) your inability to use, unauthorized use of, performance or non-performance of the site; <br/>(iii) unauthorized access to or tampering with your personal information or transmissions;<br/> (iv) the provision or failure to provide any service;<br/> (v) errors or inaccuracies contained on the site or any information, software, products, services, and related graphics obtained through the site; <br/>(vi) any transactions entered into through this site; <br/>(vii) any property damage including damage to your computer or computer system caused by viruses or other harmful components, during or on account of access to or use of this site or any site to which it provides hyperlinks; or <br>(viii) damages otherwise arising out of the use of the site, any delay or inability to use the site, or any information, products, or services obtained through the site. The limitations of liability shall apply regardless of the form of action, whether based on contract, tort, negligence, strict liability or otherwise, even if a Covered Party has been advised of the possibility of damages. 
            ...
            <p class="text-justify">
                To the extent permitted by law, in no event shall jamaliate.com, including its respective officers, directors, employees, representatives, parents, subsidiaries, affiliates, distributors, suppliers, licensors, agents or others involved in creating, sponsoring, promoting, or otherwise making available the site and its contents (collectively the "Covered Parties"), be liable to any person or entity whatsoever for any direct, indirect, incidental, special, exemplary, compensatory, consequential, or punitive damages or any damages whatsoever,including but not limited to: <br/>(i) loss of goodwill, profits, business interruption, data or other intangible losses; <br>(ii) your inability to use, unauthorized use of, performance or non-performance of the site; <br>(iii) unauthorized access to or tampering with your personal information or transmissions; <br>(iv) the provision or failure to provide any service;<br> (v) errors or inaccuracies contained on the site or any information, software, products, services, and related graphics obtained through the site;<br> (vi) any transactions entered into through this site;<br> (vii) any property damage including damage to your computer or computer system caused by viruses or other harmful components, during or on account of access to or use of this site or any site to which it provides hyperlinks; or<br> (viii) damages otherwise arising out of the use of the site, any delay or inability to use the site, or any information, products, or services obtained through the site. The limitations of liability shall apply regardless of the form of action, whether based on contract, tort, negligence, strict liability or otherwise, even if a Covered Party has been advised of the possibility of damages.
            </p>
            ...
            <ul class="text-justify">
                ...
                <br><br>
                <li>
                    To the extent not prohibited by law, if, notwithstanding the above, a Covered Party is found liable for any loss or damage relating to the use of this Site, User agrees the liability of any such party shall in no event exceed the total charge to the User assessed by jamaliate.com for making a Request
                </li>
            </ul>

            <h3>Indemnification and Chargebacks</h3>
            <p class="text-justify">
                You agree to defend and indemnify jamaliate and the Covered Parties from and against any claims, causes of action, demands, recoveries, losses, damages, fines, penalties or other costs or expenses of any kind or nature including but not limited to reasonable legal and accounting fees, brought <br>(i) by you or on behalf of you in excess of the liability described above; or <br>(ii) by third parties as a result of:
            </p>
            <ul class="text-justify">
                <li>
            ...
            <p class="text-justify">
                The material and content on this Site, including without limitation, the information, text, software, code, photographs, videos, typefaces, graphics, music, sounds, images, illustrations, maps, designs, icons, trademarks, service marks, logos, and written content (collectively, “Content”), and the arrangement and compilation of the Content, are owned by jamaliate.com, jamaliate.com’s corporate affiliates and/or the service Service Providers. It is possible that some trademarks, service marks and other company designations on the Site may belong to third parties and are used on the Site under license or for identification purposes only. The use of marks on the Site that belong to third parties, and the availability on the Site of goods or services from such third parties, should not be construed as an affiliation, endorsement or sponsorship of this Site and its services by any such third party.
            </p>

            <br/><br>

            <p class="text-justify">The Content includes but is not limited to, the following trademarks and service marks, and registered trademarks and service marks, owned by jamaliate.com: jamaliate, jamaliate.COM.
            </p>
            <p class="text-justify"> The Content on the Site is protected under U.S. and international copyright and trademark laws. Your use of and access to the Site does not grant you any license or right to use any of the Content on the Site. It is expressly prohibited for you to use, transmit, copy or reproduce the Content in any form, including on any website or in any domain name, without authorization from jamaliate.com, except if such use is for personal, non-commercial use.</p>


            <h3>Claims of Copyright Infringement</h3>
            <p class="text-justify">
                jamaliate.com respects the intellectual property rights of others and asks that you do the same. If you believe in good faith that material or content on the Site infringes your copyrighted work, you (or your agent) may send us a written notice under the Digital Millennium Copyright Act that includes the following information:
            </p>
            <ul>
                <li>
            ...
            <p class=="text-justify">Copyright infringement notifications can be sent to jamaliate.com by email, mail, as follows: </p>
            ...
            <p class="text-justify">
                You must be at least 18 years of age to be eligible to purchase, cancel or modify any services available through jamaliate. Accessing materials on this Site by certain persons in certain countries may not be lawful, and jamaliate.com makes no representation that materials on this Site are appropriate or available for use in locations outside of the United States.
                <br/><br/>
                jamaliate grants you a limited, personal, nontransferable, non-sub licensable, revocable license to access and use this Site only as expressly permitted in this Agreement. You may only use this Site to make legitimate reservations, purchases or requests to purchase the products or services offered (each, a "Request") and shall not use this Site to make any speculative, false or fraudulent Requests or any Requests in anticipation of demand. You agree to provide correct and true information in connection with your use of this Site. It is a violation of law to place a Request in a false name or with an invalid method of payment. jamaliate reserves the right to cancel any service or account or any other transaction that it reasonably believes to have been fraudulently made, including by unauthorized use of a credit or debit card.
                <br/><br/>
                Any rights or license not expressly granted herein are reserved. The content and information on this Site, as well as the infrastructure used to provide such content and information, is proprietary to jamaliate.com and/or its service Service Providers. Accordingly, you agree not to use this Site or its contents or information for any commercial or non-personal purpose or for any purpose that is unlawful or prohibited by this Agreement. While you may make limited copies of your documents for service, you agree not to modify, copy, distribute, transmit, display, reproduce, publish, license, create derivative works from, transfer, or sell or re-sell any information, software, products, or services obtained from this Site. In addition, whether or not you have a commercial purpose, you agree not to:
                <br/><br/>
            </p>
            <ul>
                <li>
                    access, monitor or copy any content or information of this Site using any robot, spider, scraper or other automated means or any manual process for any purpose without express written permission of jamaliate.com;
                </li>
                <li>
